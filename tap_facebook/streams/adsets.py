...
class AdsetsStream(IncrementalAdsStream):
    ...
    schema = PropertiesList(
        ...
        Property(
            ...
            ObjectType(
                ...
                Property("custom_conversion_id", CustomType({"type": ["integer","string","null"]})),
            ...
            ObjectType(
                ...
                Property(
                    ...
                    ObjectType(
                        ...
                        Property("places", CustomType({"type": ["array","object","null"]})),
